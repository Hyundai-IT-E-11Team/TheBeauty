...
ALTER TABLE tb_brand
    ADD CONSTRAINT tb_brand_pk PRIMARY KEY (brand_seq);
...
ALTER TABLE tb_user
    ADD CONSTRAINT tb_user_pk PRIMARY KEY (user_seq);
...
ALTER TABLE tb_reservation
    ADD CONSTRAINT tb_reservation_pk PRIMARY KEY (reservation_seq);
...
ALTER TABLE tb_category
    ADD CONSTRAINT tb_category PRIMARY KEY (category);
