			...
			<div class="prd-info-box">
				...
				<div class="prd-price-wrap">
					...
					<ul class="benefit-info-list">
						...
						<li><span class="benefit-title">적립금</span> <span
							class="benefit-desc">H.Point 80P 적립<br>KB제휴카드 결제시 최대
								1.5% 추가 적립
						</span></li>
				...
				<div class="button-option">
					<form action="/theBeauty/cart/addToCart" method="post">
						<input type="hidden" id="productCount" name="productCount" /> <input
							type="hidden" id="productSeq" name="productSeq"
							value="${productDetail.productVO.productSeq}" />
						<button type="submit" class="cart-button">장바구니</button>
					</form>
					<form action="/theBeauty/reserve/reservePage" method="post">
						<input type="hidden" id="brandSeq" name="brandSeq"
							value="${productDetail.brandVO.brandSeq}" />
