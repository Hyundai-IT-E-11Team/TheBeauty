		...
		<div class="surveywrap">
			<div class="survey">
				...
				<div class="survey-items">
					<label class="radio-label-wrapper"> <input type="radio"
						name="surveySkintype" value="건성" />건성
					</label> <label class="radio-label-wrapper"> <input type="radio"
						name="surveySkintype" value="복합성" />복합성
					</label> <label class="radio-label-wrapper"> <input type="radio"
						name="surveySkintype" value="지성" />지성
					</label> <label class="radio-label-wrapper"> <input type="radio"
						name="surveySkintype" value="민감성" />민감성
					</label>
				</div>
			</div>
			...
			<div class="survey">
				...
				<div class="survey-items">
					<label class="radio-label-wrapper"> <input type="radio"
						name="surveyPersonalColor" value="봄 웜톤" />봄 웜톤
					</label> <label class="radio-label-wrapper"> <input type="radio"
						name="surveyPersonalColor" value="여름 쿨톤" />여름 쿨톤
					</label> <label class="radio-label-wrapper"> <input type="radio"
						name="surveyPersonalColor" value="가을 웜톤" />가을 웜톤
					</label> <label class="radio-label-wrapper"> <input type="radio"
						name="surveyPersonalColor" value="겨울 쿨톤" />겨울 쿨톤
					</label> <label class="radio-label-wrapper"> <input type="radio"
						name="surveyPersonalColor" value="모름" />모름
					</label>
				</div>
			</div>
			...
			<div class="survey">
				...
				<div class="survey-items">
					<label class="radio-label-wrapper"> <input type="radio"
						name="surveyJewelryColor" value="실버" />실버
					</label> <label class="radio-label-wrapper"> <input type="radio"
						name="surveyJewelryColor" value="골드" />골드
					</label>
				</div>
			</div>
			...
			<div class="survey">
				...
				<div class="survey-items">
					<label class="radio-label-wrapper"> <input type="radio"
						name="surveySkintone" value="17호" />17호
					</label> <label class="radio-label-wrapper"> <input type="radio"
						name="surveySkintone" value="21호" />21호
					</label> <label class="radio-label-wrapper"> <input type="radio"
						name="surveySkintone" value="23호" />23호
					</label> <label class="radio-label-wrapper"> <input type="radio"
						name="surveySkintone" value="모름" />모름
					</label>
				</div>
			</div>
			...
			<div class="survey-submit">
				<input class="submit" type="button"
					onclick="safeANDmove('${currUser.userSeq}')" value="제출하기" />
			</div>
		</div>
